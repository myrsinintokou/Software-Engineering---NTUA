        ...
        try {
            if (dateArgs.date != null ) {
                ...
                if ( format.name() == "JSON" ) {
                    ...
                    System.out.println("Source,Dataset,AreaName,AreaTypeCode,MapCode,ResolutionCode,Year,Month,Day,DateTimeUTC,ActualTotalLoadValue,UpdateTimeUTC");
                    for (int i=0; i<records.size(); i++){
                        ...
                        System.out.print(records.get(i).getActualTotalLoadValue()+ ",");
                ...
                List<ATLRecordForSpecificMonth> records = new RestAPI().
                        getActualTotalLoadMonth(areaName, timeres.name(), dateArgs.month, format);
                if ( format.name() == "JSON" ) {
                    for (int i = 0; i < records.size(); i++) {
                        if (i==0){
                            System.out.println("[ {");
                    ...
                    System.out.println("Source,Dataset,AreaName,AreaTypeCode,MapCode,ResolutionCode,Year,Month,Day,ActualTotalLoadByDayValue");
                    for (int i=0; i<records.size(); i++){
                        System.out.print(records.get(i).getSource()+ ",");
                        System.out.print(records.get(i).getDataSet()+ ",");
                        System.out.print(records.get(i).getAreaName()+ ",");
                ...
                List<ATLRecordForSpecificYear> records = new RestAPI().
                        getActualTotalLoadYear(areaName, timeres.name(), dateArgs.year, format);
                if ( format.name() == "JSON" ) {
                    for (int i = 0; i < records.size(); i++) {
                        if (i==0){
                            System.out.println("[ {");
                    ...
                    System.out.println("Source,Dataset,AreaName,AreaTypeCode,MapCode,ResolutionCode,Year,Month,ActualTotalLoadByMonthValue");
                    for (int i=0; i<records.size(); i++){
                        System.out.print(records.get(i).getSource()+ ",");
                        System.out.print(records.get(i).getDataSet()+ ",");
                        System.out.print(records.get(i).getAreaName()+ ",");
